            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Daftar Data Gejala</h4>
                    ...
                    <div class="modal-body">
                        <div id="pesan-error-tmbh" class="alert alert-danger" hidden></div>
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                <input type="text" name="tambah_id_gejala" id="tambah_id_gejala" class="form-control" placeholder="XXX-xxx">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-md-2 col-form-label">Nama</label>
                                <div class="col-md-10">
                                <input type="text" name="tambah_name_gejala" id="tambah_nama_gejala" class="form-control" placeholder="Masukkan nama disiniiii....disiniii....disiniiii...">
                                </div>
                            </div>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            function tampil_data(){
                $.ajax({
                    type    : 'ajax',
                    url     : '<?php echo site_url('Gejala/gejala_data'); ?>',
                    async   : true,
                    dataType: 'json',
                        ...
                        for(i=0; i<data.length; i++){
                            html += '<tr>'+
                                    ...
                                    '<td style="text-align:right;">'+
                                        '<a href="javascript:void(0);" data-toggle="modal" data-target="#Modal_Edit" class="btn btn-info btn-sm item_edit" data-product_code="'+data[i].id+'" data-product_name="'+data[i].nama+'" >Edit</a>'+' '+
            ...
            $('#btn_simpan').on('click',function(){
                ...
                data.append('id_gejala',$('#tambah_id_gejala').val());
                data.append('nama_gejala',$('#tambah_nama_gejala').val());
                
                $.ajax({
                    type    :"POST",
                    url     :"<?php echo base_url('Gejala/save');?>",
                    //dataType:"json",
                    contentType : false,
                    processData : false,
                    dataType    : 'JSON',
                    ...
                    success : function(result){
                      if (result.status !== true) {
                        ...
                        $('[name="tambah_id_gejala"]').val("");
                        $('[name="tambah_nama_gejala"]').val("");
